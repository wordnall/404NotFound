...
import ssu.groupname.baseapplication.network.RecipeSearchAsyncTask;
            ...
            public void onClick(View v) {
                ...
                task.setListener(new RecipeSearchAsyncTask.RecipeCallbackListener() {
                    ...
                    public void onRecipeCallback(List<RecipeModel> models) {
                        Log.d("RecipeCallback", "Worked");
                        Intent recyclerViewIntent = new Intent(SearchActivity.this, SearchResultsActivity.class);
                        recyclerViewIntent.putParcelableArrayListExtra("RecipeModel", (ArrayList)models);
                        startActivity(recyclerViewIntent);
                    }
                });
                Log.d("Button", "Reached the Execute Stage");
